...
template <template <typename Type, typename Allocator> class StlContainer, typename EigenType>
using Aligned = StlContainer<EigenType, Eigen::aligned_allocator<EigenType>>;

namespace aligned {

template <typename KeyType, typename EigenType>
using Map = std::map<KeyType, EigenType, std::less<KeyType>,
                     Eigen::aligned_allocator<std::pair<const KeyType, EigenType>>>;

template <typename KeyType, typename EigenType>
using UnorderedMap =
    std::unordered_map<KeyType, EigenType, std::hash<KeyType>, std::equal_to<KeyType>,
                       Eigen::aligned_allocator<std::pair<const KeyType, EigenType>>>;

template <typename EigenType, typename ValueType>
using UnorderedMapEigenKey =
    std::unordered_map<EigenType, ValueType, std::hash<EigenType>, std::equal_to<EigenType>,
                       Eigen::aligned_allocator<std::pair<const EigenType, ValueType>>>;

template <typename EigenType>
using UnorderedSet = std::unordered_set<EigenType, std::hash<EigenType>, std::equal_to<EigenType>,
