...
class CeresBackendPublisher {
 ...
 private:
  ...
  std::shared_ptr<rclcpp::Publisher<geometry_msgs::msg::PoseStamped>> pub_imu_pose_viz_;
  std::shared_ptr<rclcpp::Publisher<sensor_msgs::msg::PointCloud2>> pub_points_;
