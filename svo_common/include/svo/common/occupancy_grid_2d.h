...
class OccupandyGrid2D {
 public:
  ...
  inline void reset() { std::fill(occupancy_.begin(), occupancy_.end(), false); }
  ...
  inline int numOccupied() const { return std::count(occupancy_.begin(), occupancy_.end(), true); }
