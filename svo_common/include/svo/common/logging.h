...
#define SVO_DEBUG_STREAM(x) RCLCPP_DEBUG_STREAM(rclcpp::get_logger("logging"), x)
#define SVO_INFO_STREAM(x) RCLCPP_INFO_STREAM(rclcpp::get_logger("logging"), x)
#define SVO_WARN_STREAM(x) RCLCPP_WARN_STREAM(rclcpp::get_logger("logging"), x)
#define SVO_ERROR_STREAM(x) RCLCPP_ERROR_STREAM(rclcpp::get_logger("logging"), x)
#else
#ifdef LUCY_LOGGING
